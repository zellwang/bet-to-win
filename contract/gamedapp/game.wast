(module
 ...
 (data (i32.const 8832) "userdetail\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 8864) "save db failed\00")
 (data (i32.const 8880) "ERROR: Get my contract name failed.\00")
 (data (i32.const 8928) "win\00")
 (data (i32.const 8944) "getBinValue failed!\00")
 (export "memory" (memory $0))
 (export "isMethod" (func $isMethod))
 (export "reguser" (func $reguser))
 (export "getuser" (func $getuser))
 (export "dobet" (func $dobet))
 (export "_GLOBAL__sub_I_game.cpp" (func $_GLOBAL__sub_I_game.cpp))
 (func $_GLOBAL__sub_I_game.cpp
   ...
   (block $label$1
    ...
    (set_local $0
     (select
      (i32.const 0)
      (i32.const 3)
      (call $_Z8saveDataI10UserDetailEjRT_PcS3_
       (i32.add
        (get_local $1)
        (i32.const 24)
       )
 ...
 (func $_Z8saveDataI10UserDetailEjRT_PcS3_ (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $getuser (result i32)
  (i32.const 0)
 )
 (func $dobet (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
     ...
     (block $label$3
      (block $label$4
       (block $label$5
        ...
        (br_if $label$4
         (i32.eqz
          (call $_Z10parseParamI7BetInfoEjRT_
           (i32.add
            (get_local $5)
            (i32.const 80)
           )
        ...
        (br_if $label$3
         (i32.eqz
          (call $_Z7getDataI10UserDetailEjPcS1_S1_RT_
           (i32.add
            (get_local $5)
            (i32.const 128)
           )
 ...
 (func $_Z10parseParamI7BetInfoEjRT_ (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $_Z7getDataI10UserDetailEjPcS1_S1_RT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
